...
```bash
git clone [https://github.com/AryanshSingh2020/DataFusion-AI-RAG-Agent-.git](https://github.com/AryanshSingh2020/DataFusion-AI-RAG-Agent-.git)
cd DataFusion-AI-RAG-Agent
```
